...
async function main() {
  ...
  const [katFiksi, katNonFiksi, katPendidikan, katReligius, katAnak, katTeknologi] = await Promise.all([
    prisma.kategoriBuku.create({
      data: { namaKategori: 'Fiksi', deskripsi: 'Novel, cerita pendek, dan karya fiksi lainnya' },
    }),
    prisma.kategoriBuku.create({
      data: { namaKategori: 'Non-Fiksi', deskripsi: 'Buku pengetahuan, biografi, dan referensi' },
    }),
    prisma.kategoriBuku.create({
      data: { namaKategori: 'Pendidikan', deskripsi: 'Buku pelajaran, panduan belajar, dan materi akademik' },
    }),
    prisma.kategoriBuku.create({
      data: { namaKategori: 'Religius', deskripsi: 'Buku agama, spiritual, dan keagamaan' },
    }),
    prisma.kategoriBuku.create({
      data: { namaKategori: 'Anak-Anak', deskripsi: 'Buku cerita dan pembelajaran untuk anak' },
    }),
    prisma.kategoriBuku.create({
      data: { namaKategori: 'Teknologi', deskripsi: 'Buku pemrograman, IT, dan teknologi' },
    }),
  ]);
  ...
  const bukuData = [
    {
      idKategori: katFiksi.idKategori,
    ...
    {
      idKategori: katPendidikan.idKategori,
      judul: 'Atomic Habits',
    ...
    {
      idKategori: katReligius.idKategori,
    ...
    {
      idKategori: katTeknologi.idKategori,
      judul: 'Clean Code',
  ...
  const alamat2 = await prisma.alamatUser.create({
    data: {
      ...
      kota: 'Bandung',
      provinsi: 'Jawa Barat',
      alamatLengkap: 'Jl. Braga No. 45, Bandung',
      kodePos: '40111',
      isDefault: true,
    },
  });
  const alamat3 = await prisma.alamatUser.create({
    data: {
      ...
      kota: 'Surabaya',
      provinsi: 'Jawa Timur',
      alamatLengkap: 'Jl. Tunjungan No. 78, Surabaya',
      kodePos: '60271',
      isDefault: true,
    },
  });
  ...
  const pengeluaranData = [
    {
      judul: 'Pembelian stok buku baru',
      nominal: 2500000,
  ...
  const ulasanData = [
    ...
    {
      idBuku: bukuList[1].idBuku,
      idUser: user1.idUser,
      rating: 5,
      komentar: 'Karya sastra yang luar biasa.',
      tanggalUlasan: daysAgo(4),
    },
    {
      idBuku: bukuList[2].idBuku,
      idUser: user2.idUser,
      rating: 4,
      komentar: 'Perspektif yang menarik tentang sejarah manusia.',
      tanggalUlasan: daysAgo(5),
    },
    {
      idBuku: bukuList[4].idBuku,
      idUser: user3.idUser,
      rating: 5,
      komentar: 'Buku terbaik tentang kebiasaan! Sangat rekomendasi.',
      tanggalUlasan: daysAgo(6),
    },
    {
      idBuku: bukuList[3].idBuku,
      idUser: user2.idUser,
      rating: 4,
      komentar: 'Stoicism yang dikemas ringan dan modern.',
      tanggalUlasan: daysAgo(10),
    },
    {
      idBuku: bukuList[5].idBuku,
      idUser: user1.idUser,
      rating: 4,
      komentar: 'Sangat membantu untuk meningkatkan fokus.',
      tanggalUlasan: daysAgo(12),
    },
    {
      idBuku: bukuList[11].idBuku,
      idUser: user2.idUser,
      rating: 5,
      komentar: 'Wajib baca untuk setiap programmer!',
      tanggalUlasan: daysAgo(14),
    },
    {
      idBuku: bukuList[10].idBuku,
      idUser: user3.idUser,
      rating: 4,
      komentar: 'Ceritanya menyentuh hati.',
      tanggalUlasan: daysAgo(18),
    },
  ];
  ...
  const menungguOrders = pesananList.filter(
    (p) =>
      p.statusPesanan === 'menunggu_pembayaran' ||
      p.statusPesanan === 'menunggu_verifikasi' ||
  ...
  await prisma.pesanKontak.createMany({
    data: [
      ...
      },
      {
        ...
        subjek: 'Cara pengembalian buku',
        isiPesan: 'Saya menerima buku dalam kondisi rusak, bagaimana cara pengembalian?',
        tanggalKirim: daysAgo(3),
      },
    ],
  });
  ...
  console.log('   - 12 buku');
  console.log(
    '   - 31 pesanan (20 selesai, 3 diproses, 2 dikirim, 2 menunggu pembayaran, 2 menunggu verifikasi, 2 dibatalkan)',
  );
