        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="max-w-2xl relative z-10">
            ...
            <motion.p
              ...
              Koleksi buku kurasi terbaik dari fiksi hingga pengembangan diri. Nikmati pengalaman belanja buku yang
              tenang, cepat, dan terpercaya.
            </motion.p>
            ...
            <motion.div
              ...
              <Link
                href="/katalog"
                className="bg-slate-900 text-white px-8 py-4 rounded-full font-medium hover:bg-slate-800 transition-all duration-300 hover:shadow-xl hover:-translate-y-1 flex items-center justify-center gap-2">
                Lihat Katalog
                <ArrowRight className="w-4 h-4" />
              </Link>
              <Link
                href="/register"
                className="bg-white border border-slate-200 text-slate-900 px-8 py-4 rounded-full font-medium hover:bg-slate-50 transition-all duration-300 flex items-center justify-center">
                Daftar Sekarang
              </Link>
            </motion.div>
            ...
            <motion.div
              ...
              <div className="flex -space-x-3">
                {[1, 2, 3].map((i) => (
                  <img
                    key={i}
                    src={`https://picsum.photos/64/64?random=${i}`}
                    className="w-10 h-10 rounded-full border-2 border-[#FDFBF7]"
                    alt="User"
                  />
                ))}
              </div>
          ...
          <motion.div
            ...
            <div className="relative grid grid-cols-2 gap-4 w-full max-w-md transform rotate-[-6deg] hover:rotate-0 transition-transform duration-700 ease-out cursor-default">
              <img
                ...
                className="w-full h-64 object-cover rounded-lg shadow-lg transform translate-y-12"
                alt="Book"
              />
              <img
              ...
              <img
                ...
                className="transform w-full h-64 object-cover rounded-lg shadow-lg translate-y-12"
                alt="Book"
              />
              <img
