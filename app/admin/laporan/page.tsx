          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-3xl font-bold">{data.totalPesanan} <span className="text-lg font-normal opacity-80">Pesanan</span></h3>
                    ...
                    data.orders.map((order: any, idx) => (
                      ...
                      >
                        <td className="px-6 py-4 text-slate-600 font-medium">
                          {new Date(order.tanggalPesan).toLocaleDateString('id-ID', { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric' })}
                        </td>
