      ...
      <div className="flex items-center gap-6">
        ...
        <div className="relative hidden md:block" ref={searchRef}>
          <div className="flex items-center bg-slate-100 rounded-full px-4 py-2.5 w-64 focus-within:ring-2 focus-within:ring-amber-500/20 transition-all focus-within:w-80">
            ...
            />
            {isSearching && <div className="animate-spin rounded-full h-3 w-3 border-b-2 border-amber-600 ml-2"></div>}
          </div>
                    ...
                    {searchResults.buku.map((buku: any) => (
                      <Link
                        ...
                        <div className="overflow-hidden">
                          <p className="text-sm font-medium text-slate-700 truncate group-hover:text-amber-600">
                            {buku.judul}
                          </p>
                      ...
                      <Link
                        ...
                        <div className="overflow-hidden">
                          ...
                          <p className="text-xs text-slate-500 truncate">
                            {pesanan.user.namaLengkap} • {pesanan.statusPesanan}
                          </p>
                        </div>
                      </Link>
                    ))}
                      ...
                      notifikasi.map((n) => (
                        <div
                          ...
                          className={`p-4 border-b border-slate-50 hover:bg-slate-50 transition-colors ${
                            !n.sudahDibaca ? 'bg-amber-50/30' : ''
                          }`}>
                          <div className="flex gap-3">
                            <div
                              className={`mt-1 w-2 h-2 rounded-full flex-shrink-0 ${
                                !n.sudahDibaca ? 'bg-amber-500' : 'bg-slate-300'
                              }`}
                            />
                            <div>
