...
function BukuContent() {
  ...
  const filteredBooks = books.filter((b) => {
    ...
    const matchesStatus = filterStatus === 'all' || (filterStatus === 'active' ? b.statusAktif : !b.statusAktif);
              ...
              {loading ? (
                ...
                filteredBooks.map((book) => (
                  <tr key={book.idBuku} className="hover:bg-slate-50/80 transition-colors group">
                    ...
                    <td className="px-6 py-5 text-slate-600">{book.pengarang}</td>
                    <td className="px-6 py-5 text-slate-600">{book.tahunTerbit}</td>
                    <td className="px-6 py-5">
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="p-8 space-y-8 overflow-y-auto">
                ...
                <div className="flex items-center gap-3 p-4 bg-slate-50 rounded-xl border border-slate-100">
                  ...
                  />
                  <div>
                    <label htmlFor="statusAktif" className="text-sm font-semibold text-slate-800 block">
                      Status Aktif
                    </label>
