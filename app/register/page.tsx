    ...
    <div className="min-h-screen flex items-center justify-center bg-[#FDFBF7] px-6">
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-600">Sudah punya akun? <Link href="/login" className="text-amber-700 hover:text-amber-800 font-medium">Masuk di sini</Link></p>
        </div>

        <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-8">
          <p className="text-slate-600 text-center">
            Halaman registrasi akan diimplementasikan di phase berikutnya dengan validasi dan keamanan penuh.
          </p>
